...
<template>
    <Form v-bind="form" class="space-y-6" v-slot="{ errors, processing }">
        <div class="grid gap-6 xl:grid-cols-2">
            <AdminFormSection
                title="Event details"
                description="Name and description shown to coordinators."
            >
            ...
            <AdminFormSection
                ...
                description="Venue, type, and lifecycle status."
            >
        ...
        <AdminFormSection
            title="Schedule"
            description="Dates and check-in windows. Sessions auto-start at check-in open time."
        >
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p class="text-sm text-muted-foreground">
                    Set check-in, check-out, and on-time cutoff for each day.
                </p>
                <label
                    for="is_multi_day"
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div
                    ...
                    :key="index"
                    class="admin-card-muted space-y-4 p-4"
                >
        ...
        <AdminFormSection
            ...
            description="QR rotation and duplicate attendance policy."
        >
